...
# can we use the newest/stable version of nexus?
# sudo wget [https://download.sonatype.com/nexus/3/nexus-3.39.0-01-unix.tar.gz]
sudo tar -zxvf nexus-3.15.2-01-unix.tar.gz
# sudo tar -zxvf nexus-3.39.0-01-unix.tar.gz
sudo mv /opt/nexus-3.15.2-01 /opt/nexus
# sudo mv /opt/nexus-3.39.0-0 /opt/nexus
```
